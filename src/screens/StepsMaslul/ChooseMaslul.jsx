...
function ChooseMaslul(props) {
  ...
  return(
    ...
    <div >
      ...
      <button style={{margin:30,backgroundColor:"#c4a092",color:"white",fontSize:15,width:'80%',height:40,borderColor:"#e8e8e8" , borderWidth:1,borderRadius:50}}  onClick={props.clickMaslulOne} > בחירת מסלול </button>
    ...
    <div className="card"  style={{ width:'18rem',margin:50,float:"left",border: '#c4a092 solid 2px'}} >
      ...
      <button style={{margin:30,backgroundColor:"#c4a092",color:"white",fontSize:15,width:'80%',height:40,borderColor:"#e8e8e8" , borderWidth:1,borderRadius:50}}  onClick={props.clickMaslulTwo}> בחירת מסלול </button>
