...
<label className='label'>
  ...
  <input type="radio" name="user_skinProblem" value="קמטים"   onChange={props.handleChange}/>
...
<label className='label'>
    ...
    <input type="radio" name="user_skinProblem" value="אקנה" onChange={props.handleChange}/>
...
<label className='label'>
    ...
    <input type="radio" name="user_skinProblem" value="יובש" onChange={props.handleChange}/>
...
<label className='label'>
    ...
    <input type="radio" name="user_skinProblem" value="שומן" onChange={props.handleChange}/>
...
<label className='label'>
    ...
    <input type="radio" name="user_cheek" value="יבשות" onChange={props.handleChange}/>
...
<label className='label'>
    ...
    <input type="radio" name="user_cheek" value="שומניות" onChange={props.handleChange}/>
...
<label className='label'>
    ...
    <input type="radio" name="user_Tzone" value="יבשות" onChange={props.handleChange}/>
    <img alt="oilyface" height="100" width="100" src={require("../../assets/images/dry.png")}/>
...
<label className='label'>
    ...
    <input type="radio" name="user_Tzone" value="שומניות" onChange={props.handleChange}/>
    <img alt="oilyface" height="100" width="100" src={require("../../assets/images/oilyface.png")}/>
