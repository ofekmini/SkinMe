...
export default function ChooseUser() {
  ...
  return (
    ...
    <div>
      ...
      <Link to="/signupuser">
      <ButtonLogIn style={{backgroundColor:"black",color:"white",fontSize:15,width:'60%',height:40,borderColor:"#e8e8e8" ,margin:20, borderWidth:1,borderRadius:50}} name="משתמש רגיל " />
      </Link>
