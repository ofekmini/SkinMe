...
import { Link } from 'react-router-dom';
 ...
 class MaslulInfo extends Component {
  ...
  render() {
    ...
    <button style={{margin:30,backgroundColor:"#c4a092",color:"white",fontSize:15,width:'80%',height:40,borderColor:"#e8e8e8" , borderWidth:1,borderRadius:50}} onClick={this.saveMaslul} > הבא  </button>
