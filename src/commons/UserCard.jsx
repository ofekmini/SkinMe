...
const UserCard = (props) => {
  ...
  return (
    <div className="card"  style={{backgroundColor:'#EEE4C4', width:'10rem',height:'20rem',margin:5,marginRight:20,float:"right",border: 'black solid 1px', padding:5,borderRadius:10}} >
    ...
    <div className="card-body">
      ...
      <Link to='/addskinplan' >
      <ButtonLogIn  style={{backgroundColor:"#c4a092",color:"white",fontSize:15,width:'60%',height:40,borderColor:"#e8e8e8" , borderWidth:1,borderRadius:50}} name=" יצירת תוכנית טיפוח " onClick={showId}/>
      </Link>
